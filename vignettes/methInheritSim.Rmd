...
proportion of those sites, as fixed by **rateDiff**.
...
* Synthetic chromosome in GRanges format
* Simulation information in GRanges format
* stateDiff and stateInfo
...
* The string "stateInfo"
* The code of the simulation (the **fileID** parameter, ex: "S1"") 
