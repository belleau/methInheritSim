...
as DMS, the same beta distribution as the control is used to simulate. For the DMS, a 
proportion (vpDiff) of the cases are selected and the C/T follow a shift Beta 
distribution (the parameter are estimated with mean control - or + vDiff). 
