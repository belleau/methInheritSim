...
proportion of C/T of the selected cases follow a shift Beta distribution 
...
If saveGRanges parameters is TRUE, for each n simulations with the 
parameters groups vNbSample vpDiff, 
