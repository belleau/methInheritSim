...
test.runSim_good_001 <- function() {
    ...
    methylGR_1_1_1 <- new("methylRaw", data.frame(chr = rep("S", 8), 
                                       start = c(1000, 1003, 1022, 1029, 11029, 11048, 11052, 11058), 
                                       end = c(1000, 1003, 1022, 1029, 11029, 11048, 11052, 11058),
                                       strand = strand("+"),
    ...
    methylGR_1_1_4 <- new("methylRaw", data.frame(chr = rep("S", 8), 
                                                  ...
                                                  strand = strand("+"),
                                                  coverage = c(74, 93, 68, 94, 71, 70, 75, 78), 
                                                  numCs = c(1, 1, 0, 1, 0, 1, 0, 1),
                                                  numTs = c(73, 92, 68, 93, 71, 69, 75, 77)),
    ...
    methylGR_1_1_7 <- new("methylRaw", data.frame(chr = rep("S", 8), 
                                                  ...
                                                  strand = strand("+"),
                                                  coverage = c(71, 80, 91, 75, 79, 87, 91, 70), 
                                                  numCs = c(59, 66, 74, 61, 61, 71, 72, 58),
                                                  numTs = c(12, 14, 17, 14, 18, 16, 19, 12)),
    ...
    methylGR_1_1_9 <- new("methylRaw", data.frame(chr = rep("S", 8), 
                                                  ...
                                                  strand = strand("+"),
                                                  coverage = c(84, 66, 74, 85, 63, 63, 88, 68), 
                                                  numCs = c(68, 55, 60, 69, 52, 51, 72, 56),
                                                  numTs = c(16, 11, 14, 16, 11, 12, 16, 12)),
